// ============================================================                                                            
// Example:     LCDML: use GTFT display  https://www.arduino.cc/en/Main/GTFT                         
// ============================================================
// Autor:       Markus Rudel
...
// ============================================================ 
  ...
  // include libs
  #include <TFT.h>    // Lib:  https://www.arduino.cc/en/Main/GTFT  
...
// https://www.arduino.cc/en/Main/GTFT
  ...
  TFT gfx = TFT(TFT_CS, TFT_DC, TFT_RST);
...
// *********************************************************************
  ...
  {  
    ...
    gfx.setCursor(0, _LCDML_ADAFRUIT_FONT_H * (3));
    gfx.println("LCDMenuLib v2.3.2");
