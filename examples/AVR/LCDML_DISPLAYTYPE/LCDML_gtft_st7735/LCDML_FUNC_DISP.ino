...
// *********************************************************************
{
  // setup function
  // clear lcd
  gfx.fillScreen(_LCDML_ADAFRUIT_BACKGROUND_COLOR); 
  // set text color / Textfarbe setzen
  gfx.setTextColor(_LCDML_ADAFRUIT_TEXT_COLOR);  
  // set text size / Textgroesse setzen
  gfx.setTextSize(_LCDML_ADAFRUIT_FONT_SIZE);

  gfx.setCursor(0, _LCDML_ADAFRUIT_FONT_H * 0); // line 0
  gfx.println(F("To close this")); 
  gfx.setCursor(0, _LCDML_ADAFRUIT_FONT_H * 1); // line 1
  gfx.println(F("function press")); 
  gfx.setCursor(0, _LCDML_ADAFRUIT_FONT_H * 2); // line 2
  gfx.println(F("any button or use")); 
  gfx.setCursor(0, _LCDML_ADAFRUIT_FONT_H * 3); // line 3
  gfx.println(F("back button")); 
...
// *********************************************************************
{
  ...
  gfx.println(buf); 
  gfx.setCursor(0, _LCDML_ADAFRUIT_FONT_H * 1); // line 1
  gfx.println(F("or press back button")); 
...
{ 
  ...
  gfx.setCursor(0, _LCDML_ADAFRUIT_FONT_H * 0); // line 0
  gfx.println(F("press a or w button")); 
  gfx.setCursor(0, _LCDML_ADAFRUIT_FONT_H * 1); // line 1
  gfx.println(buf); 
